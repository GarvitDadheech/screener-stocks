    ...
    <footer className="bg-white text-sm py-4 pb-8 px-10 md:px-24 flex flex-col md:flex-row items-center justify-between h-auto mt-24 w-full">
      <div className="flex flex-col items-center  md:items-start text-center md:text-left space-y-4 mt-10">
        ...
        <div className="flex flex-col items-center text-center md:text-left md:items-start text-[13px]">
          ...
          <a href="https://www.screener.in/" className="mt-4 underline">
            Terms & Privacy.
          </a>
        </div>
      </div>
      <div className="flex md:mr-20 gap-x-6 md:gap-x-16 mt-6 md:mt-0 justify-between">
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-2 md:ml-16 mt-2 md:mt-0">
          ...
          <a
            ...
            className="hover:text-indigo-500 text-[12.5px] text-gray-500"
          >
            Premium
          </a>
          <a
          ...
          <button className="flex items-center border border-blue-500 text-indigo-500 tracking-wider py-1 px-1 md:px-3 rounded-lg">
            <FontAwesomeIcon icon={faBoltLightning} className="mr-3 text-xs" />{" "}
            INSTALL
          </button>
        </div>
